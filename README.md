...
| Architecture refinement and exploratory coding              | [architecture-refinement](skills/architecture-refinement/SKILL.md)                                                                                   |
...
The expert-discipline hook proactively nudges Pi to read
`architecture-refinement` for consequential choices, uncertain
requirements, issue refinement, or lost understanding, in any project
where the skill is available. The full workflow loads when relevant;
