...
workflows. [package.json](package.json) declares the loaded extensions and skills.
...
The check runs typechecking, the current test suite, package/docs checks, and
README consistency. It is **not** an exhaustive integration certification.
